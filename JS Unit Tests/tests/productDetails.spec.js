...
describe('#productDetails', () => {
  it('tests the function has the correct behaviour', () => {
    ...
    assert.strictEqual( isArray(product), true);
    ...
    const product1 = productDetails('a', 'b');
    const array = product1.splice(0, 2);
    const string1 = (array[0].details.productId).slice(-3);
    const string2 = (array[1].details.productId).slice(-3);
